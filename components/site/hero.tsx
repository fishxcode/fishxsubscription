...
export function Hero({ locale, dictionary }: HeroProps) {
  return (
    <main className="relative overflow-hidden">
      ...
      <section className="relative mx-auto flex min-h-screen w-full max-w-7xl flex-col px-6 pb-24 pt-8 md:px-8 lg:px-12">
        <header className="flex items-center justify-between rounded-full border border-border/70 bg-card/60 px-5 py-3 backdrop-blur">
